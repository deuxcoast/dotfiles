...
local util = require("modules.ui.config.heirline.util")

local mode = util.mode
local icons = util.icons
local deux_icons = require("deux.icons")
...
local Diagnostics = {
  ...
  static = {
    -- error_icon = '󰂭 ',
    error_icon = deux_icons.Error,
    warn_icon  = deux_icons.Warn,
    info_icon  = deux_icons.Warn,
    hint_icon  = deux_icons.Hint,
  },
  init = function(self)
