local smallcaps = require("util.string").smallcaps
...
return {
  {
...

    {
...

      {
        provider = function()
          if
              conditions.buffer_matches({
                buftype = require("util.buffer").SPECIAL_BUFTYPES,
                filetype = require("util.buffer").SPECIAL_FILETYPES,
              })
          then
            return ""
          end
        ...
        hl = function()
          return active_highlight(
            require("util.treesitter").is_highlight_enabled() and "DiffAdd"
            or "DiffDelete"
          )
        end,
      },
...

    {
...

      {
        provider = function(self)
          ...
          local cwd_relative = require("util.path").common_root(cwd, path)
...

  {
    ...
    require("modules.ui.config.heirline.lsp"),
    require("modules.ui.config.heirline.formatters"),
    require("modules.ui.config.heirline.diagnostics"),
  },
}
