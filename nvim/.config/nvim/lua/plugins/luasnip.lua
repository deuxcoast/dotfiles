return {
    ...
    init = function()
        local make = R("duex.snippets").make

        local present, ls = pcall(require, "luasnip")
        if not present then
            return
        end
        -- <M-n> is my expansion key
    ...
    config = function()
        ...
        ls.add_snippets(nil, {
            ...
            snippet("lf", t "local $1 = function($2)\n $0\nend"),
  ...
  --]]
        ...
        for _, ft_path in ipairs(vim.api.nvim_get_runtime_file("lua/duex/snippets/ft/*.lua", true)) do
            loadfile(ft_path)()
        end
    end,
}
