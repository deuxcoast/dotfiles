...
M.setup = function()
  ...
  map.n('<leader>ff', finder.project_files, { desc = 'Find project files' })
  map.n('<leader>fs', builtin.live_grep, { desc = 'Find grep' })
  map.n('<leader>fb', builtin.buffers, { desc = 'Find buffers' })
  map.n('<leader>ft', builtin.colorscheme, { desc = 'Find colorscheme' })
  map.n('<leader>fg', builtin.git_bcommits, { desc = 'Find buffer commits' })
  map.n('<leader>fG', builtin.git_commits, { desc = 'Find project commits' })
  map.n('<leader>fn', cmd 'Telescope nvim_config', { desc = 'Find nvim_config' })
