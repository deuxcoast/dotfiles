...
SPOTIFY_EVENT="com.apple.iTunes.playerInfo"
POPUP_SCRIPT="sketchybar -m --set music.anchor popup.drawing=toggle"

Pmusic_notify=(
  script="$HOME/.config/sketchybar/plugins/music.sh"
  ...
  drawing=off
  y_offset=2
)OPUP_SCRIPT="sketchybar -m --set music.anchor popup.drawing=toggle"
...
sketchybar --add event spotify_change $SPOTIFY_EVENT             \
           ...
           --add bracket spotify.controls spotify.shuffle        \
                                          ...
                                          spotify.next           \
                                          spotify.repeat         \
           --set spotify.controls "${spotify_controls[@]}"       \o
sketchybar -m --add event song_update 
