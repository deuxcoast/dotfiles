...
local function set_default_keymaps(_, bufnr)
    ...
    vim.keymap.set("n", "<leader>vn", ":lua vim.diagnostic.goto_next({ border = 'rounded' })<cr>", opts)
    vim.keymap.set("n", "<leader>vp", ":lua vim.diagnostic.goto_prev({ border = 'rounded' })<cr>", opts)
