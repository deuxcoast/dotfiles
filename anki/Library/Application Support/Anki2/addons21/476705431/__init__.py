...
def wrap_in_tags(editor, tag1, tag2, class_name=None):
    ...
    tag_string_begin = ("<{0}><{1} class='language-{2}'>".format(tag1, tag2, class_name) if
                        class_name else "<{0}><{1}>".format(tag1, tag2))
...
def addMyButton(buttons, editor):
    ...
    return buttons + [
        editor._addButton(os.path.join(os.path.dirname(__file__),"icons","gopher_inverse.png"), "button_wrap_go", "Highlight Go code"),
        editor._addButton(os.path.join(os.path.dirname(__file__),"icons","c_icon_inverse.png"), "button_wrap_c", "Highlight C code"),
        editor._addButton(os.path.join(os.path.dirname(__file__),"icons","ts_icon_inverse.png"), "button_wrap_ts", "Highlight Typescript code"),
        editor._addButton(os.path.join(os.path.dirname(__file__),"icons","lua_icon_inverse2.png"), "button_wrap_lua", "Highlight Lua code"),
        editor._addButton(os.path.join(os.path.dirname(__file__),"icons","regex_icon_inverse2.png"), "button_wrap_regex", "Highlight Regex"),
        editor._addButton(os.path.join(os.path.dirname(__file__),"icons","sql_icon_inverse2.png"), "button_wrap_sql", "Highlight SQL code"),
        editor._addButton(os.path.join(os.path.dirname(__file__),"icons","bash_icon.png"), "button_wrap_bash", "Highlight Bash code"),
        editor._addButton(os.path.join(os.path.dirname(__file__),"icons","code_icon_inverse.png"), "button_wrap_code", "Inline code"),
                      ]
